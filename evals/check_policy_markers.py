...
CHECKS = {
    ...
    "docs/maintainers/release.md": [
        ...
        "validation also rejects unsafe paths",
        "2 MiB per entry and 8 MiB total",
        "3 MiB per entry and 12 MiB total",
        "at most 16 MiB",
        "central directory at most 64 KiB",
        "no more than 11 entries",
        "declaring more than 64 entries",
        "Directory entries must have zero uncompressed content",
        "valid deflated-empty stream is allowed",
        "standard Unix or DOS creator metadata",
        "Unix type bits and the DOS directory bit must agree",
        "files owner-readable and directories owner-readable/searchable",
        "hidden, system, or reserved DOS attributes are not allowed",
        "Source-tree manifest membership and uncompressed sizes are checked",
        "symbolic links, reparse points",
        "special files are rejected without being followed",
        "Hard-linked regular files are copied as ordinary bytes and are allowed",
        "every central entry must use disk zero",
        "canonical single-disk layout",
        "no executable/SFX prefix",
        "ZIP64 or other unsupported records",
        "Local and central ZIP headers must agree",
        "DOS modification date/time",
        "Extraction version 1.0 or 2.0 is required",
        "if present",
        "extended timestamp",
        "modification-time flag and one four-byte time",
        "no general-purpose flags",
        "escaped and length-bounded",
